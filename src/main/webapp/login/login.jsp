...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="${pageContext.request.contextPath}/login/${pageContext.request.contextPath}/login/assets/ico/apple-touch-icon-114-precomposed.png">
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${pageContext.request.contextPath}/Admin/login" method="post"
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 38px" class="captchaImage"
